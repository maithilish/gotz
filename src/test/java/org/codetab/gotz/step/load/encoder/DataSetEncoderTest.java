...
public class DataSetEncoderTest {

    @Mock
    private EncoderHelper encoderHelper;
    @InjectMocks
    private DataSetEncoder encoder;
    ...
    public void testEncode() throws Exception {
        ...
        List<DataSet> actual = encoder.encode(data);

        List<DataSet> expected =
                Arrays.asList(new DataSet("n", "g", "m0-cv", "m0-rv", "m-0-fv"),
                        new DataSet("n", "g", "m1-cv", "m1-rv", "m-1-fv"));
