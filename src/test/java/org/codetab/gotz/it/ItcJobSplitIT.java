...
public class ItcJobSplitIT {
    ...
    @Test
    public void itcJobSplitJSoupTest() {

        System.setProperty("gotz.beanFile", "/itest/itc/job-split/bean.xml");
        ...
        List<String> expected =
                TestUtil.readFileAsList("/itest/itc/job-split/expected.txt");
    ...
    @Test
    public void itcJobSplitHtmlUnitTest() {

        System.setProperty("gotz.beanFile",
                "/itest/itc/job-split/htmlunit/bean.xml");
        ...
        List<String> expected = TestUtil
                .readFileAsList("/itest/itc/job-split/htmlunit/expected.txt");
