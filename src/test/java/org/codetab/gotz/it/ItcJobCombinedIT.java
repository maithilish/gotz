...
public class ItcJobCombinedIT {
    ...
    @Test
    public void itcJobCombinedJSoupTest() {

        System.setProperty("gotz.beanFile", "/itest/itc/job-combined/bean.xml");
        ...
        List<String> expected =
                TestUtil.readFileAsList("/itest/itc/job-combined/expected.txt");
    ...
    @Test
    public void itcJobCombinedHtmlUnitTest() {

        System.setProperty("gotz.beanFile",
                "/itest/itc/job-combined/htmlunit/bean.xml");
        ...
        List<Object> actual = listAppender.getList();
        List<String> expected = TestUtil.readFileAsList(
                "/itest/itc/job-combined/htmlunit/expected.txt");
