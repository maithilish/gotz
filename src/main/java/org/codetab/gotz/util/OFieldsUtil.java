...
public final class OFieldsUtil {
    ...
    public static Field getField(final FieldsBase fieldsBase, final String name)
            throws FieldNotFoundException {
        Iterator<FieldsBase> ite = fieldsBase.iterator();
        while (ite.hasNext()) {
            FieldsBase f = ite.next();
            if (f instanceof Field && f.getName().equals(name)) {
                return (Field) f;
    ...
    public static List<FieldsBase> getFieldsList(final List<FieldsBase> fields,
            final String name) throws FieldNotFoundException {
        List<FieldsBase> list = new ArrayList<>();
        FieldsIterator ite = new FieldsIterator(fields);
        while (ite.hasNext()) {
